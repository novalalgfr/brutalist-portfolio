...
export default function Home() {
	...
	return (
		...
		>
			...
			<div
				className="border-y-4 border-neo-black bg-neo-lime text-neo-black py-4 rotate-5 scale-105 z-10 relative transform-gpu outline outline-1 outline-transparent"
