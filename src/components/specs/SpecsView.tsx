						...
						<div className="spec-card bg-neo-white border-4 border-neo-black p-6 shadow-neo">
							...
							<div className="flex flex-wrap gap-2">
								{[
									...
									<span
										key={tech}
										className="px-3 py-1 bg-gray-200 border-2 border-neo-black font-bold text-xs hover:bg-neo-lime hover:translate-x-1 hover:translate-y-1 transition-all text-neo-black"
									>
										{tech}
									</span>
								))}
